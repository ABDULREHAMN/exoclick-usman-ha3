...
export function DashboardContent({ onNavigate }: DashboardContentProps) {
  ...
  const allReportData = [
    ...
    { date: "June 13, 2026", impressions: 3002, clicks: 167, revenue: 29.13, ctr: "5.56%", ecpm: "83.67" },
  ]
