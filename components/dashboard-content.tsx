...
export function DashboardContent({ onNavigate }: DashboardContentProps) {
  ...
  const availableBalance = 603.27
  const pendingBalance = 1050.33
  const thisMonthEarnings = 688.00
  const lastMonthEarnings = 1928.56
  const last6MonthsEarnings = 2616.56
  const thisMonthForecast = 1533.33
  const totalPayments = 498.21
  const totalEarnings = 2616.56
  const nextWithdrawalDate = "June 16, 2026"

  // Today's data - June 9, 2026
  const todayRevenue = 32.22
  const todayImpressions = 6532
  const todayClicks = 163
  const todayCTR = "2.50"
  ...
  const allReportData = [
    ...
    { date: "June 9, 2026", impressions: 6532, clicks: 163, revenue: 32.22, ctr: "2.50%", ecpm: "83.33" },
  ]
